...
zqry1.SQL.Clear;
zqry1.SQL.Add('insert into jenis_pelanggaran values(null,"'+edt1.text+'","'+edt2.text+'","'+edt3.text+'","'+edt4.text+'","'+edt5.text+'","'+edt6.text+'","'+edt7.text+'")');
zqry1.ExecSQL;
...
begin
  zqry1.SQL.Clear;
  zqry1.SQL.Add('delete from jenis_pelanggaran where no ="'+no+'"');
  zqry1.ExecSQL;
  zqry1.SQL.Clear;
  zqry1.SQL.Add('select * from jenis_pelanggaran');
  zqry1.Open;
